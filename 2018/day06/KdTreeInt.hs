...
module KdTreeInt where
    ...
    class Point p where
          ...
          -- |dist2 returns the manhattan distance between two points.
          dist2 :: p -> p -> Int
    ...
    data Point3d = Point3d { p3x :: Int, p3y :: Int, p3z :: Int }
        ...
        where xProbe = coord axis probe
              ...
              findNearest tree1 tree2 =
                    let candidate1 = case nearestNeighbor tree1 probe of
                        ...
                        sphereIntersectsPlane = abs (xProbe - xPivot) <= dist2 probe candidate1
    ...
    nearNeighbors :: Point p => KdTree p -> Int -> p -> [p]
